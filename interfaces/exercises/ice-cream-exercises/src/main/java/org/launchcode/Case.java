...
public class Case {
    ...
    public Case(){
        ...
        Topping topping2= new Topping("Whipped Cream", 0.15, new ArrayList<>(Arrays.asList("dairy")), 8);
        Topping topping3= new Topping("M&Ms", 0.50, new ArrayList<>(Arrays.asList("dairy")), 6);
